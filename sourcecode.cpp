...
public:
    ...
    void editmembership(int key)
    {
        ...
        {
            cout<<endl<<"Entered id not present!!"<<endl<<endl;
        }
        ...
        if(ad_pw==apw)
        {
            ...
            switch(opt)
            {
                ...
                case 4://edit membership
                       ...
                       editmembership(iddd);
                       break;
                case 5:  cout<<"THE ID NUMBERS OF USERS ARE LISTED BELOW:"<<endl;
                         for(int id:ids)
                        {
                            cout<<id<<endl;
                        }
                    cout<<"enter the user's id number to delete his/her membership:";
                       cin>>iddd;
